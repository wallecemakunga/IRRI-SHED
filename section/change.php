...
if($pass==$old){
  if($new==$new2){
    ...
    $query="UPDATE users set Password='$new' WHERE Email='".$_SESSION['username']."'";
    $result = mysqli_query($connection,$query);
    ...
    <p><a href='section.php'><button class='button button--success' data-for='success'>Return to home Page</button></a></p>
    </div>
    </div>";
